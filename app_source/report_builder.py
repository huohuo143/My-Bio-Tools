...
def build_excel_report(bundle: AnalysisBundle) -> bytes:
    ...
    overview = [
        ...
        {"item": "interpretation_model_label", "value": bundle.interpretation_status.get("model_label", "")},
        {"item": "interpretation_reasoning_effort", "value": bundle.interpretation_status.get("reasoning_effort", "")},
        {"item": "interpretation_reasoning_label", "value": bundle.interpretation_status.get("reasoning_label", "")},
        {"item": "interpretation_speed", "value": bundle.interpretation_status.get("speed", "")},
        {"item": "interpretation_speed_label", "value": bundle.interpretation_status.get("speed_label", "")},
