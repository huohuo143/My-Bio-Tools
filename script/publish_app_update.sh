...
DMG="${2:-$ROOT_DIR/dist/My-Bio-Tools-1.9.1-arm64.dmg}"
...
RELEASE_NOTES="${MY_BIO_TOOLS_RELEASE_NOTES:-新增 ChatGPT 账号（Codex，免 API Key）自动解读；每次联网确认、严格结构化输出、安全回退离线规则，并同步进入网页、Word、Excel 和 ZIP。}"
