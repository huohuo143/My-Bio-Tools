...
当前 macOS 与 Windows 功能基线均为 **1.9.7（build 26）**。macOS 目标平台为 Apple Silicon（arm64），最低支持 macOS 13；Windows 目标平台为 Windows 10/11 x64，并通过原生 Windows GitHub Actions 构建和验收。
